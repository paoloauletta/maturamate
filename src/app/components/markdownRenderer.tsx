    ...
    <div className={`markdown-content ${className}`}>
      <ReactMarkdown 
        ...
        components={{
          ...
          code: (props) => <code {...props} className="bg-muted rounded px-1 py-0.5" />,
          pre: (props) => <pre {...props} className="bg-muted rounded p-3 mb-4 overflow-x-auto" />,
          blockquote: (props) => <blockquote {...props} className="border-l-4 border-muted pl-4 italic mb-4" />,
          img: (props) => (
            <img
