...
export function Hero() {
  return (
    <>
      <div className="h-screen w-full flex items-center justify-center bg-gradient-to-b from-blue-800 to-bg-primary antialiased bg-grid-white/[0.02] relative overflow-hidden light">
        <Spotlight />
